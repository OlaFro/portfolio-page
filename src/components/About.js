      ...
      <StyledCard height="60rem" color="#EEC170" zIndex="5" about>
        <StyledAboutContainer>
          ...
          <StyledText>
            ...
            were ready to dive into programming basics and have spent the whole
            Summer learning <strong>Vanilla JavaScript</strong>. Getting to know{" "}
            <strong>node.js</strong> was then the first step to the Back-End and
            gave us the foundations to understand <strong>Express.js</strong>.
            In the Front-End we've learned <strong>React.js</strong> and spent
            six weeks practicing <strong>Class Components</strong>,{" "}
            <strong>Hooks</strong>, <strong>React Router</strong>,
            <strong>Context API</strong>, and finally <strong>Redux</strong>.
